...
/**
 * This class is responsible for all the information needed in order to
 * undo or redo an action in the drawing canvas.
 *
 * @author Dale Skrien
...
public class UndoRedoHandler
{
    ...
    /**
     * constructor
     * @param canvas the DrawingCanvas whose changes are saved for
     *        later restoration.
     */
    ...
    /**
     * saves the current state of the drawing canvas for later
     * restoration
     */
    ...
    /**
     * restores the state of the drawing canvas to what it was before
     * the last change.
     * Nothing happens if there is no previous state (for example, when
     * the application first starts up or when you've already undone
     * all actions since the startup state).
     */
    public void undo()
    {
    ...
    /**
     * restores the state of the drawing canvas to what it was before
     * the last undo action was performed.
     * If some change was made to the state of the canvas since the last
     * undo, then this method does nothing.
     */
    public void redo()
    {
