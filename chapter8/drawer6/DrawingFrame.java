 ...
 * and and Edit menu with undo, redo, group and ungroup actions.
 *
 * @author Dale Skrien
...
public class DrawingFrame extends JFrame
{
     ...
     * an "Exit" menu item.  The Edit menu has "Undo", "Redo", "Group",
     * and "Ungroup" menu items.
     ...
     * @param undoRedoHandler the UndoRedoHandler that handles the undo and
     *                        redo behavior
     */
     ...
     * @param undoRedoHandler the UndoRedoHandler that causes the undo and
     *                        redo behavior to occur
     */
                                    ...
                                    UndoRedoHandler undoRedoHandler)
    {
        ...
        final CreationTool ellipseTool =
                new CreationTool(new Ellipse(0, 0, 60, 40), undoRedoHandler);
        final CreationTool squareTool =
                new CreationTool(new Square(0, 0, 50), undoRedoHandler);
        final CreationTool rectTool =
                new CreationTool(new Rect(0, 0, 60, 40), undoRedoHandler);
