 ...
 * the drawing canvas.
 * It implements all the methods for dealing with selection,
 * intersection, movement, and highlighting.
 * It has an abstract drawShape method.
 *
 * @author Dale Skrien
        ...
        implements Cloneable
{
    ...
    public List<Figure> getComposedFigures()
    {
